...
@Step(
        id = "HadoopDeleteStep",
        name = "HadoopDelete.Name",
        description = "HadoopDelete.TooltipDesc",
        image = "org/steps/hadoop/resources/demo3.svg",
...
public class HadoopDeleteMeta extends BaseStepMeta implements StepMetaInterface {
    private static final Class<?> PKG = HadoopDeleteMeta.class; // for i18n purposes
    ...
    public HadoopDeleteMeta() {
        super();
    }
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
        return new HadoopDeleteDialog( shell, meta, transMeta, name );
    }
    @Override
    public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
                                  Trans disp ) {
        return new HadoopDeleteStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
    }
