 ...
 **/
public class HadoopDeleteDialog extends BaseStepDialog implements StepDialogInterface {
    private static final Class<?> PKG = HadoopDeleteMeta.class;
    private HadoopDeleteMeta meta;
    private LabelText user;
    private LabelText uri;
    private LabelText path;
    private LabelText output;

    public HadoopDeleteDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        meta = (HadoopDeleteMeta) in;
    }
    @Override
    public String open() {
