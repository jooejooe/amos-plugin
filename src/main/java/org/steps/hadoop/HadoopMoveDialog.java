 ...
 **/
public class HadoopMoveDialog extends BaseStepDialog implements StepDialogInterface {
    private static final Class<?> PKG = HadoopMoveDialog.class;
    private HadoopMoveMeta meta;
    ...
    public HadoopMoveDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        meta = (HadoopMoveMeta) in;
    }
    @Override
    public String open() {
