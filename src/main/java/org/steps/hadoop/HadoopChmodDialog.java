 ...
 **/
public class HadoopChmodDialog extends BaseStepDialog implements StepDialogInterface {
    private static final Class<?> PKG = HadoopChmodDialog.class;
    private HadoopChmodMeta meta;
    private LabelText user;
    private LabelText uri;
    private LabelText path;
    private LabelText output;
    private LabelText privige;
    public HadoopChmodDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        meta = (HadoopChmodMeta) in;
    }
    @Override
    public String open() {
        ...
        privige = new LabelText( shell, BaseMessages.getString( PKG, "Hadoop.privige.Label" ), null );
        props.setLook( privige );
        privige.addModifyListener( lsMod );
        ...
        privige.setLayoutData( fdValName4);
        ...
        setButtonPositions( new Button[] { wOK, wCancel }, margin, privige );
        ...
        privige.addSelectionListener( lsDef );
    ...
    private void populateDialog() {
        ...
        privige.setText(null==meta.getHadoop().getPrivige()?"": meta.getHadoop().getPrivige());
    }
    ...
    private void ok() {
        ...
        meta.getHadoop().setPrivige(privige.getText() );
        dispose();
    }
}