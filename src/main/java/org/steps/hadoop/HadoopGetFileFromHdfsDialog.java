 ...
 **/
public class HadoopGetFileFromHdfsDialog extends BaseStepDialog implements StepDialogInterface {
    private static final Class<?> PKG = HadoopGetFileFromHdfsDialog.class;
    private HadoopGetFileFromHdfsMeta meta;
    private LabelText user;
    private LabelText uri;
    private LabelText path;
    private LabelText output;
    private LabelText pathFrom;

    public HadoopGetFileFromHdfsDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        meta = (HadoopGetFileFromHdfsMeta) in;
    }
    @Override
    public String open() {
        ...
        shell.setText( BaseMessages.getString( PKG, "Hadoop.Delete.Shell.Title" ) );
        ...
        pathFrom = new LabelText( shell, BaseMessages.getString( PKG, "Hadoop.pathFrom.Label" ), null );
        props.setLook( pathFrom );
        pathFrom.addModifyListener( lsMod );
        ...
        pathFrom.setLayoutData( fdValName4);
        ...
        setButtonPositions( new Button[] { wOK, wCancel }, margin, pathFrom );
        ...
        pathFrom.addSelectionListener( lsDef );
    ...
    private void populateDialog() {
        ...
        pathFrom.setText(null==meta.getHadoop().getPathFrom()?"": meta.getHadoop().getPathFrom());
    }
    ...
    private void ok() {
        ...
        meta.getHadoop().setPathFrom(pathFrom.getText() );
        dispose();
    }
}