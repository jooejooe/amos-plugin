 ...
 **/
public class HadoopCatDialog extends BaseStepDialog implements StepDialogInterface {
    private static final Class<?> PKG = HadoopDeleteMeta.class;
    private HadoopCatMeta meta;
    private LabelText user;
    private LabelText uri;
    private LabelText path;
    private LabelText output;

    public HadoopCatDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        meta = (HadoopCatMeta) in;
    }
    @Override
    public String open() {
