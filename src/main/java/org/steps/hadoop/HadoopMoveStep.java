 ...
 **/
public class HadoopMoveStep extends BaseStep implements StepInterface {
    private static final Class<?> PKG = HadoopMoveStep.class; // for i18n purposes
    ...
    public HadoopMoveStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
    ...
    public boolean init(StepMetaInterface smi, StepDataInterface sdi ) {
        ...
        HadoopMoveMeta meta = (HadoopMoveMeta) smi;
