...
@Step(
        id = "HadoopCatStep",
        name = "HadoopCat.Name",
        description = "HadoopCat.TooltipDesc",
        image = "org/steps/hadoop/resources/demo.svg",
...
public class HadoopCatMeta extends BaseStepMeta implements StepMetaInterface {
    private static final Class<?> PKG = HadoopCatMeta.class; // for i18n purposes
    ...
    public HadoopCatMeta() {
        super();
    }
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
        return new HadoopCatDialog( shell, meta, transMeta, name );
    }
    @Override
    public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
                                  Trans disp ) {
        return new HadoopCatStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
    }
