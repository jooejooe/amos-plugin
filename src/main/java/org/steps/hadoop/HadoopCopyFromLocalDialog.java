 ...
 **/
public class HadoopCopyFromLocalDialog extends BaseStepDialog implements StepDialogInterface {
    private static final Class<?> PKG = HadoopDeleteMeta.class;
    private HadoopCopyFromLocalMeta meta;
    ...
    public HadoopCopyFromLocalDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
        super( parent, (BaseStepMeta) in, transMeta, sname );
        meta = (HadoopCopyFromLocalMeta) in;
    }
    @Override
    public String open() {
