 ...
 **/
public class HadoopCatStep extends BaseStep implements StepInterface {
    private static final Class<?> PKG = HadoopCatStep.class; // for i18n purposes
    ...
    public HadoopCatStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
    ...
    public boolean init(StepMetaInterface smi, StepDataInterface sdi ) {
        ...
        HadoopCatMeta meta = (HadoopCatMeta) smi;
