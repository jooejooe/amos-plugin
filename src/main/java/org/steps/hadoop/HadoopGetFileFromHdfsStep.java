 ...
 **/
public class HadoopGetFileFromHdfsStep extends BaseStep implements StepInterface {
    private static final Class<?> PKG = HadoopGetFileFromHdfsStep.class; // for i18n purposes
    ...
    public HadoopGetFileFromHdfsStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
    ...
    public boolean init(StepMetaInterface smi, StepDataInterface sdi ) {
        ...
        HadoopGetFileFromHdfsMeta meta = (HadoopGetFileFromHdfsMeta) smi;
...
//            String output= (String)outputRow[outputIndex];
            ...
            String str=HdfsUtil.getFileFromHDFS(bean);
