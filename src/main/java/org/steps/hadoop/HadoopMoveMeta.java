...
@Step(
        id = "HadoopMoveStep",
        name = "HadoopMove.Name",
        description = "HadoopMove.TooltipDesc",
        image = "org/steps/hadoop/resources/demo6.svg",
...
public class HadoopMoveMeta extends BaseStepMeta implements StepMetaInterface {
    private static final Class<?> PKG = HadoopMoveMeta.class; // for i18n purposes
    ...
    public HadoopMoveMeta() {
        super();
    }
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
        return new HadoopMoveDialog( shell, meta, transMeta, name );
    }
    @Override
    public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
                                  Trans disp ) {
        return new HadoopMoveStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
    }
