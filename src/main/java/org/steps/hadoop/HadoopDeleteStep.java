 ...
 **/
public class HadoopDeleteStep extends BaseStep implements StepInterface {
    private static final Class<?> PKG = HadoopDeleteStep.class; // for i18n purposes
    ...
    public HadoopDeleteStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta, Trans trans) {
    ...
    public boolean init(StepMetaInterface smi, StepDataInterface sdi ) {
        ...
        HadoopDeleteMeta meta = (HadoopDeleteMeta) smi;
    ...
    public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
        ...
        try{
            ...
            bean.setPath(path);
            bean.setUser(user);
            String str=HdfsUtil.delete(bean);
