 ...
 **/
@Step(
        id = "HadoopGetFileFromHdfsStep",
        name = "HadoopGetFileFromHdfs.Name",
        description = "HadoopGetFileFromHdfs.TooltipDesc",
        image = "org/steps/hadoop/resources/demo4.svg",
...
public class HadoopGetFileFromHdfsMeta extends BaseStepMeta implements StepMetaInterface {
    private static final Class<?> PKG = HadoopGetFileFromHdfsMeta.class; // for i18n purposes
    ...
    public HadoopGetFileFromHdfsMeta() {
        super();
    }
    public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
        return new HadoopGetFileFromHdfsDialog( shell, meta, transMeta, name );
    }
    @Override
    public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
                                  Trans disp ) {
        return new HadoopGetFileFromHdfsStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
    }
